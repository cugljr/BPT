...
from src.utils.data_utils import pc_norm, read_triangle_mesh, sample_pc, to_mesh, write_pts
...
def get_args():
    ...
    args.save_folder = join("results", "single_estimated_normal", args.exp_name)
    return args
...
def save_outputs(save_folder, mesh_pred, pc_input=None, mesh_gt=None, face_color=None):
    ...
    if pc_input is not None:
        write_pts(
            pc_input,
            join(save_folder, "pc_input_xyz.ply"),
        )
