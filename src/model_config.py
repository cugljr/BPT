...
class BPTModelConfig:
    ...
    def __init__(
        ...
        self.model = MeshTransformer(
            ...
            miche_disable_checkpoint=miche_disable_checkpoint,
            ptv2_repo_path=ptv2_repo_path,
            ptv2_encoder_ckpt=ptv2_encoder_ckpt,
            ptv2_freeze=ptv2_freeze,
            max_seq_len=max_seq_len,
